...
public class ReportingBaseWithId   {
  private String marketResearchReportRequestReference = null;
   ...
   * @return marketResearchReportRequestReference
  **/

  public String getMarketResearchReportRequestReference() {
    return marketResearchReportRequestReference;
  }

  public void setMarketResearchReportRequestReference(String marketResearchReportRequestReference) {
    this.marketResearchReportRequestReference = marketResearchReportRequestReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary general-info: 'the content of a specific report or database in any suitable form' 
